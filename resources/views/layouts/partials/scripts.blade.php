<script src="{{asset('js/deleteEdit.js')}}"></script> {{-- Todas las vistas --}}
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script> {{-- Todas las vistas --}}
<script src="{{asset('js/jquery.min.js')}}"></script>  {{-- Todas las vistas --}}
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script> {{-- Todas las vistas --}}
