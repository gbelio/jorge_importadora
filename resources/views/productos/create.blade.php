    ...
    <section class="offset-0 col-11 form-categorias">
        <div class="agregarProducto">
            <div style="display:flex; flex-direction:row; justify-content:space-between">
                <h3 style="display:inline-block">Agregar Producto</h3>
            ...
            <div id="target" style="display:none">
                ...
                <form class="form-group" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="description" value="{{ old("description") }}" class="form-control" maxlength="190">
                    </div>
                    @error('description')
                    <span class="errors">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="button">
                        <label for="poster" class="add_img"><strong>Selecionar Imagen</strong> </label>
